...
{
    [DbContext(typeof(SaleManagementMigrationsDbContext))]
    [Migration("20201116052847_remove_softDelete_Room")]
    partial class remove_softDelete_Room
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SaleManagement.Models.Distributor", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("SaleManagement.Models.ImportReceipt", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SaleManagement.Models.ImportReceiptDetail", b =>
                {
            ...
            modelBuilder.Entity("SaleManagement.Models.Room", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SaleManagement.Models.SaleReceipt", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SaleManagement.Models.SaleReceiptDetail", b =>
                {
                    ...
                    b.HasKey("SaleReceiptId", "ProductId");

                    b.HasIndex("ProductId");

                    b.ToTable("SaleReceiptDetails");
                });
            ...
            modelBuilder.Entity("Volo.Abp.Identity.IdentityUser", b =>
                {
                    ...
                    b.Property<int>("FailedLoginsNumber")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SaleManagement.Models.ImportReceiptDetail", b =>
                {
                    b.HasOne("SaleManagement.Models.Distributor", "Distributor")
                        .WithMany("ImportReceiptDetails")
                        .HasForeignKey("DistributorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SaleManagement.Models.ImportReceipt", "ImportReceipt")
                        .WithMany("ImportReceiptDetails")
            ...
            modelBuilder.Entity("SaleManagement.Models.SaleReceiptDetail", b =>
                {
                    b.HasOne("SaleManagement.Models.Product", "Product")
                        .WithMany("SaleReceiptDetails")
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SaleManagement.Models.SaleReceipt", "SaleReceipt")
                        .WithMany("SaleReceiptDetails")
